...
- **File Upload Feature**: Teachers can upload model answer keys, and students can upload their answer sheets (PDF, image, or text) for automatic evaluation.
...
### File Upload Feature
- **Teachers**: Log in as a teacher, go to your tests, and click "Upload Model Key" to upload the model answer key file (PDF, image, or text).
- **Students**: Log in as a student, click "Upload Answer Sheet", select a test, and upload your answer sheet file. The system will evaluate it against the model key and display the score.
